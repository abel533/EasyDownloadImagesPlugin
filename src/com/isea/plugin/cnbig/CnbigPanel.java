...
public class CnbigPanel extends BasePanel {
	...
	public void download(String savePath,int timeout) {
		...
		log("开始下载");
		log("保存路径:"+savePath);
		this.setDownloadHelper(new CnbigDownLoad());
	...
	private boolean checkField(){
		try {
			...
			JOptionPane.showMessageDialog(CnbigPanel.this, e.getMessage(), "提示", JOptionPane.WARNING_MESSAGE);
			return false;
		}
		return true;
	}

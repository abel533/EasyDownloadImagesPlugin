...
public class FourChanPanel extends BasePanel {
	...
	public FourChanPanel() {
		setBorder(new EmptyBorder(2, 4, 2, 0));
		setLayout(null);
		
		JLabel lblhttpwwwblogcompage = new JLabel("该模式针对一般模式中，图片地址为//开头的，主要为4chan这样的网站");
		...
		url = new JTextField();
		url.setText("http://boards.4chan.org/");
